  ...
  const [transactions, setTransactions] = useState<Transaction[]>([
    {
      ...
      customerId: '1',
      items: [
        { productId: '1', productName: 'Premium Rice - Basmati', quantity: 10, price: 42.00, total: 420.00 },
        { productId: '2', productName: 'Olive Oil - Extra Virgin', quantity: 5, price: 120.00, total: 600.00 }
      ],
      subtotal: 1020.00,
      tax: 81.60,
      discount: 50.00,
